{/* Auto-generated benchmark table from 8/1/2025. Do not edit manually. */}
  ...
  <strong>기준(Baseline):</strong> [v1.2.3](https://github.com/foundry-rs/foundry/releases/tag/v1.2.3)

  <strong>최신(Latest):</strong> [v1.3.0](https://github.com/foundry-rs/foundry/releases/tag/v1.3.0)

  최신 릴리스에 대한 자세한 내용은 [여기](/releases)에서 확인하세요.
<table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '1rem', marginBottom: 0 }}>
  <thead>
    <tr style={{ borderBottom: '2px solid var(--vocs-color_border)' }}>
      <th style={{ padding: '0.4rem', textAlign: 'left', fontWeight: 600 }}>저장소 (Repository)</th>
